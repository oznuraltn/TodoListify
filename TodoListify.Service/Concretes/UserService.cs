...
public sealed class UserService(UserManager<User> _userManager, UserBusinessRules _userBusinessRules) : IUserService
{
    ...
    {
        _userBusinessRules.CheckIfEmailIsUniqueAsync(dto.Email);
        _userBusinessRules.CheckIfPasswordIsStrong(dto.Password);
